...
@click.option('--video-format', default="mp4" ,required=False, help="The video format that you want to the automation find all videos, default: mp4")
@click.option('--output-format', default="mp4" ,required=False, help="The format that you want automation to output, default: mp4")
@click.option('--output-sufix', default="-subtitled" ,required=False, help="The output sufix that you want on output, default: subtitled")
@click.option('--subtitle-sufix', default=".srt" ,required=False, help="The sufix of the subtitle file, default: .srt")
